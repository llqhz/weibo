    ...
    <div class="card-body">
      ...
      <form action="{{ route('users.update', $user) }}" method="post">
        ...
        <div class="form-group">
          ...
          <input id="email" type="email" disabled name="email" class="form-control" value="{{ $user->email }}">
        </div>

        <div class="form-group">
          <label for="password">密码：</label>
          <input id="password" type="password" name="password" class="form-control" value="{{ ord('password') }}">
        </div>
